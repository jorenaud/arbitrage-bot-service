...
function on_edit_user(id, username, firstname, lastname, email, mobile, tenantId, privilege, status) {

    load_page_content("/setting/edit_user_view",
        {
            id: id,
            username: username,
            firstname: firstname,
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res == "success") {
                ...
                load_page_content("/setting/user_view");
