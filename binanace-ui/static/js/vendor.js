...
function on_add_vendor() {

    load_page_content("/vendor/add_vendor_view");
}

function on_edit_vendor(id, name, domain, keywords) {

    load_page_content("/vendor/edit_vendor_view/",
        {
            id: id,
            name: name,
            domain: domain,
