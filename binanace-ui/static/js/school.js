...
function on_add_school() {

    load_page_content("/school/add_school_view");
}

function on_edit_school(id, name, address, city, province, postalCode, headMaster, phone, mobile, email, schoolTypeId, tenantId) {

    load_page_content("/school/edit_school_view/",
        {
            "id": id,
            "name": name,
            "address": address,
