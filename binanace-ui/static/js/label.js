...
function on_edit_rule(id, sku, service, status) {

	load_page_content("/setting/label_view/",
	{
...
function on_delete_rule(id, sku) {
...
function on_modal_add() {
    ...
    var sku = $("#dlg_sku").val();
    var service = $("#dlg_service").val();
    var status = $("#dlg_status").val();

    if (sku == null || sku == "") {
        alert("Please input a Sku.");
        return;
    }
