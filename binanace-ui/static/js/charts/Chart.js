...
module.exports = function(Chart) {
	...
	Chart.Interaction = {
		...
		modes: {
			...
			/**
			 * Point mode returns all elements that hit test1 based on the event position
			 * of the event
			...
			/**
			 * x mode returns the elements that hit-test1 at the current x coordinate
			...
			/**
			 * y mode returns the elements that hit-test1 at the current y coordinate
