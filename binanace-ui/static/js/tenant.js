...
(function($) {
	...
	function getMockForRequest( handler, requestSettings ) {
		...
		if ( $.isFunction(handler.url.test) ) {
			// The user provided a regex for the url, test1 it
...
function on_add_tenant() {

    load_page_content("/tenant/add_tenant_view");
}

function on_edit_tenant(id, code, name, address, city, province, postalCode, contactPerson, phone, mobile, email) {

    load_page_content("/tenant/edit_tenant_view/",
        {
            "id": id,
            "code": code,
            "name": name,
...
function on_show_schools(id) {

    load_page_content("/school/?tenantId=" + id);
}

function on_delete_tenant(id) {
